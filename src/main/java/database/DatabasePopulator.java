...
public class DatabasePopulator {
    ...
    //Soggiorno
    Prodotto p11= new Prodotto("Divano modulare in tessuto","Comodo e personalizzabile, adatto a qualsiasi spazio.",89.99,ImageUtil.readImageFromResources("images/soggiorno/divano.jpg"),Categoria.SOGGIORNO, 270, true, true );
    ...
    Prodotto p15= new Prodotto("Poltrona reclinabile ergonomica","Comfort assoluto per lettura e relax.",19.99,ImageUtil.readImageFromResources("images/soggiorno/poltrona.jpg"),Categoria.SOGGIORNO, 270, true, true );
    ...
    //Bagno
    Prodotto p21= new Prodotto("Set di asciugamani in cotone egiziano","Morbidi, assorbenti e delicati sulla pelle.",9.99,ImageUtil.readImageFromResources("images/bagno/Cucina.jpg"),Categoria.BAGNO, 270, true, true );
    Prodotto p22= new Prodotto("Doccia a soffione con LED","Getto regolabile e illuminazione colorata per un’esperienza rilassante.",9.99,ImageUtil.readImageFromResources("images/bagno/Cucina.jpg"),Categoria.BAGNO, 270, true, true );
    Prodotto p23= new Prodotto("Mobiletto sospeso con specchio","Pratico e salvaspazio, con vano portaoggetti nascosto.",19.99,ImageUtil.readImageFromResources("images/bagno/Cucina.jpg"),Categoria.BAGNO, 270, true, true );
    Prodotto p24= new Prodotto("Tappetino antiscivolo per doccia","Sicurezza e comfort con materiale drenante.",4.99,ImageUtil.readImageFromResources("images/bagno/Cucina.jpg"),Categoria.BAGNO, 270, true, true );
    Prodotto p25= new Prodotto("Dispenser automatico di sapone","Igienico e moderno, con sensore di movimento.",2.99,ImageUtil.readImageFromResources("images/bagno/Cucina.jpg"),Categoria.BAGNO, 270, true, true );
    Prodotto p26= new Prodotto("Portasciugamani riscaldato","Mantiene gli asciugamani caldi e asciutti.",14.99,ImageUtil.readImageFromResources("images/bagno/Cucina.jpg"),Categoria.BAGNO, 270, true, true );
    Prodotto p27= new Prodotto("Organizer per trucchi e cosmetici","Struttura trasparente con scomparti pratici.",6.99,ImageUtil.readImageFromResources("images/bagno/Cucina.jpg"),Categoria.BAGNO, 270, false, true );
    Prodotto p28= new Prodotto("Set di accessori in ceramica","Porta sapone, spazzolini e dispenser dal design coordinato.",14.99,ImageUtil.readImageFromResources("images/bagno/Cucina.jpg"),Categoria.BAGNO, 270, false, true );
    Prodotto p29= new Prodotto("Cesto portabiancheria pieghevole","Capiente, leggero e facile da riporre.",4.99,ImageUtil.readImageFromResources("images/bagno/Cucina.jpg"),Categoria.BAGNO, 270, false, false );
    Prodotto p30= new Prodotto("Piantina da bagno purificante","Assorbe umidità e dona un tocco di verde naturale.",1.99,ImageUtil.readImageFromResources("images/bagno/Cucina.jpg"),Categoria.BAGNO, 270, false, false );

    //Giardino
    Prodotto p31= new Prodotto("Set di sedie e tavolo da esterno","Arredo elegante e resistente alle intemperie, perfetto per rilassarsi all’aperto.",14.99,ImageUtil.readImageFromResources("images/giardino/Cucina.jpg"),Categoria.GIARDINO, 270, true, true );
    Prodotto p32= new Prodotto("Barbecue a carbone con coperchio","Ideale per grigliate all’aperto con cottura uniforme e saporita.",29.99,ImageUtil.readImageFromResources("images/giardino/Cucina.jpg"),Categoria.GIARDINO, 270, true, true );
    Prodotto p33= new Prodotto("Fontana da giardino a energia solare","Aggiunge un tocco rilassante con il suono dell’acqua che scorre.",24.99,ImageUtil.readImageFromResources("images/giardino/Cucina.jpg"),Categoria.GIARDINO, 270, true, true );
    Prodotto p34= new Prodotto("Amaca in cotone con supporto","Perfetta per momenti di relax immersi nel verde.",29.99,ImageUtil.readImageFromResources("images/giardino/Cucina.jpg"),Categoria.GIARDINO, 270, true, true );
    Prodotto p35= new Prodotto("Lampade solari da esterno","Ricaricabili al sole, illuminano vialetti e giardini senza fili.",7.99,ImageUtil.readImageFromResources("images/giardino/Cucina.jpg"),Categoria.GIARDINO, 270, true, true );
    Prodotto p36= new Prodotto("Serra da giardino in policarbonato","Protegge piante e ortaggi dalle intemperie.",14.99,ImageUtil.readImageFromResources("images/giardino/Cucina.jpg"),Categoria.GIARDINO, 270, true, true );
    Prodotto p37= new Prodotto("Set di attrezzi da giardinaggio","Include pala, rastrello, forbici e guanti per la cura delle piante",9.99,ImageUtil.readImageFromResources("images/giardino/Cucina.jpg"),Categoria.GIARDINO, 270, false, true );
    Prodotto p38= new Prodotto("Casetta in legno per attrezzi","Spaziosa e resistente, perfetta per organizzare gli strumenti da giardinaggio.",4.99,ImageUtil.readImageFromResources("images/giardino/Cucina.jpg"),Categoria.GIARDINO, 270, false, true );
    Prodotto p39= new Prodotto("Dondolo a 3 posti con tettuccio","Comfort assicurato con seduta imbottita e protezione dal sole.",49.99,ImageUtil.readImageFromResources("images/giardino/Cucina.jpg"),Categoria.GIARDINO, 270, false, false );
    Prodotto p40= new Prodotto("Irrigatore automatico programmabile","Distribuisce l’acqua in modo uniforme per un prato sempre verde.",9.99,ImageUtil.readImageFromResources("images/giardino/Cucina.jpg"),Categoria.GIARDINO, 270, false, false );
